...
export default function Footer() {
  ...
  const footerMessages: FooterMessages =
    ...
    rawMessages !== null &&
    "footer" in (rawMessages as Record<string, unknown>)
      ? ((rawMessages as Record<string, unknown>)["footer"] as FooterMessages)
      : {
          brand: {
            logoAlt: "gobonki",
            tagline: "Your digital stamp card solution",
            social: {},
          },
          columns: [],
  ...
  const brand = footerMessages.brand ?? {
    logoAlt: "gobonki",
    tagline: "Your digital stamp card solution",
    social: {},
  };
  const columns: Column[] = Array.isArray(footerMessages.columns)
    ? (footerMessages.columns as Column[])
    : [];
